...
class PostLimitAdmin
{
	...
	{
		$configVars = [
			['check', PostLimit::NAME . '_enable','help' => PostLimit::NAME . '_enable_help'],
			['large_text', PostLimit::NAME . '_custom_message', 'help' => PostLimit::NAME . '_custom_message_help'],
			['int', PostLimit::NAME . '_post_count_alert', 'help' => PostLimit::NAME . '_post_count_alert_help'],
			['large_text', PostLimit::NAME . '_custom_alert_message', 'help' => PostLimit::NAME . '_custom_alert_message_help'],
		];
